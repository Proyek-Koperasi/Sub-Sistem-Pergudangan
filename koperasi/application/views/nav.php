    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li><a href="<?php echo base_url(); ?>c_pembelian/data"><i class="fa fa-file-text"></i> <span>Barang Masuk</span></a></li>
                <li><a href="<?php echo base_url(); ?>c_penjualan/data"><i class="fa fa-file-text"></i> <span>Barang Keluar</span></a></li>
